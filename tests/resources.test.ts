...
describe("Documentation Resources", () => {
  ...
  it("should get concept documentation", async () => {
    const content = await getDocumentation("midnight://docs/concepts/zero-knowledge");
...
describe("Code Resources", () => {
  ...
  it("should get patterns code", async () => {
    const content = await getCode("midnight://code/patterns/privacy-preserving");
